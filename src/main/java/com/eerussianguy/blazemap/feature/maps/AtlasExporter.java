...
public class AtlasExporter {
    ...
    public static class Task {
        ...
        public Task(ResourceKey<Level> dimension, BlazeRegistry.Key<MapType> map, List<BlazeRegistry.Key<Layer>> layers) {
            this(dimension, map, layers, TileResolution.FULL);
        }

        public Task(ResourceKey<Level> dimension, BlazeRegistry.Key<MapType> map, List<BlazeRegistry.Key<Layer>> layers, TileResolution resolution) {
