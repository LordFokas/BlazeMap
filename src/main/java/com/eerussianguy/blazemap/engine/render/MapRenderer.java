package com.eerussianguy.blazemap.engine.render;
...
import com.eerussianguy.blazemap.lib.async.AsyncAwaiter;
...
public class MapRenderer implements AutoCloseable {
    ...
    public MapRenderer(int width, int height, ResourceLocation textureResource, double minZoom, double maxZoom) {
        ...
        playerMarker = new Marker<>(BlazeMap.resource("local_player"), player.level.dimension(), player.blockPosition(), PLAYER).setSize(32).setRotation(player.getRotationVector().y);
    ...
    public void setDisabledLayers(List<BlazeRegistry.Key<Layer>> layers) {
        this.layers_off.clear();
    ...
    public List<BlazeRegistry.Key<Overlay>> getDisabledOverlays() {
        return this.overlays_off;
    }

    public void setDisabledOverlays(List<BlazeRegistry.Key<Overlay>> overlays) {
    ...
    public List<BlazeRegistry.Key<Overlay>> getVisibleOverlays() {
        return overlays_on;
    }
